                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="table" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <td colspan="6">
                                           <span class="report-search-container">
                                           <span class="report-search report-search1"><input type="text" placeholder="Name" size="10" class="input-FW full-width" /></span>
                                            <span class="report-search report-search2">
                                            <select name="type" id="type" class="input-FW full-width">
                        					        <option value=""></option>
                                            ...
                                            <span class="report-search report-search3 client_list edit-icon1"><button class="btn-create actToggle" type="button"><i class="fas fa-plus-circle"></i></button></span>                                           
                                           </span>
                                        </td>
                                    </tr>
                                    </thead>
