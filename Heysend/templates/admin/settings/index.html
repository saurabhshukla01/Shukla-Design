                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
						        ...
						        <?php  } ?>     
                <div class="table-responsive acctInfo">
                    <h3>Personal Details<a href="<?php echo base_url() ?><?php echo $TYPE;?>/settings/index-info"><i class="fa fa-pencil" aria-hidden="true"></i> Edit Details</a></h3>
                    <ul><li>Full Name:</li><li><?php echo isset($data->first_name)?$data->first_name:''?> <?php echo (isset($data->last_name))?$data->last_name:'';?></li></ul>
                    <ul><li>Mobile:</li><li><?php echo (isset($data->mobile_no)?$data->mobile_no:'')?></li></ul>
                    <ul><li>Email:</li><li><?php echo (isset($data->email)?$data->email:'')?></li></ul>
                    <ul><li>Password:</li><li>***************</li></ul>
                </div>                        
                            </div>
                        </div>
                    </div> <!-- end col -->
