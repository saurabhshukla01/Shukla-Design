                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php } echo form_open('admin/domains/index', ['enctype'=>'multipart/form-data']); ?>
                                <div class="row">
                                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">Domain Name<span class="text-danger">*</span></label>
                            <input type="name" class="form-control <?php if(form_error('name')!=''){ echo "parsley-error"; } ?>" name="name" value="<?php echo isset($name)?$name:''?>" id="name" parsley-trigger="change" required placeholder="Domain Name" tabindex="1"  maxlength="50" data-parsley-error-message="Please enter valid name.">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "columnDefs": [ {
                ...
                "render": function ( data, type, row ) {
                    return '<button  alt="Edit" title="Edit" class="btn-edit actToggle" type="button" data-original-title="Edit" id="'+ row.domain_id+'" data-id="'+ row.domain_id+'" data-uid="'+ row.domain_id+'"><i class="far fa-edit" aria-hidden="true"></i></button><button alt="Delete" title="Delete" class="btn-delete actToggle" data-original-title="Delete" type="button" data-id="'+ row.domain_id+'" data-uid="'+ row.domain_id+'"><i class="fa fa-trash"></i></button>';
                },
                "defaultContent": ''
                },
             ],
		...
		$("#table thead select,input").on( 'keyup change', function (e){
         ...
         $('#table tbody').on('click', '.btn-edit', function (e) {
            ...
            $(location).attr('href', '/admin/domains/index/'+uid+'')
         } );
